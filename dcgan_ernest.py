...
out_path = os.path.join(*[os.getcwd(), 'outputs', f'ernesgd_lr{opt.lr}_data{opt.dataset_name}'])
out_fnames = {}
...
optimizer_G = ERNESGD(generator.parameters(), lr=opt.lr)
optimizer_D = ERNESGD(discriminator.parameters(), lr=opt.lr)
